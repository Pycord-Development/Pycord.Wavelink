...
html_context = {
    ...
    'pycord_wavelink_extensions': [
        ('discord.ext.wavelink.ext.spotify', 'ext/spotify'),
    ],
}
...
latex_documents = [
    ('index', 'discord.ext.wavelink.tex', 'Pycord.Wavelink Documentation',
     'Pycord Development', 'manual'),
]

man_pages = [
    ('index', 'discord.ext.wavelink', 'Pycord.Wavelink Documentation',
     ['Pycord Development'], 1)
]

texinfo_documents = [
    ('index', 'discord.ext.wavelink', 'Pycord.Wavelink Documentation',
     'Pycord Development', 'discord.ext.wavelink', 'One line description of project.',
     'Miscellaneous'),
]
